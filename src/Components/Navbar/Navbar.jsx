  ...
  return (
    <>
        <AppBar style={{ height: '90px'}} position="fixed" className={classes.appBar} color="primary" >
            <Toolbar>
            <Grid container>  
                <Typography inline variant="body1" component = { Link } to="/" style={{width: "120px"}}>
                ...
                <Typography inline variant="h5" className={classes.title} component={Link} to="/login-form" align="center">
                <AccountCircleIcon style={{ fontSize: "50px" , width: "50" , bottom:"8px", position:"absolute", right:"150px",  color: "#FFFFFF"}}/>
                </Typography>
